...
public class EqnSolver3x3 {
    ...
    public static void main(String[] args) {
        // Declaring a multi-dimensional(3x3) array to store coefficients
        double[][] m = new double[3][3];
        // Declaring a single dimensional array(3x1) to store constants
        double[] c = new double[3];

        // Getting equations from the user
        Scanner sc = new Scanner(System.in);
        System.out.println("Enter 3 linear equations with 3 variables: ");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            String[] coefElements = eq.split("[xyz]");
        ...
        // Replacing column 3 with the constants using the replaceCol method
        double detAz = det(replaceCol(m, c, 2));
